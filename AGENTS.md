...
These instructions apply to automation and coding agents working in `messaging-intel-test` repositories unless a repository defines stricter local policy.

## Durable engineering policy

- This repository defines public organization-wide defaults for `messaging-intel-test`.
...
- GitHub organization: https://github.com/messaging-intel-test
- Public organization defaults: https://github.com/messaging-intel-test/.github
...
3. Review linked pull requests, issues, Linear work, related repositories in `messaging-intel-test`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
