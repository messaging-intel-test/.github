# .github
Organization policy and shared workflows for messaging-intel-test


<!-- ore-org-baseline:begin -->
## Organization-wide defaults

This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`messaging-intel-test`](https://github.com/messaging-intel-test).
