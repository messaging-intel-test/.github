...
- **GitHub organization:** [messaging-intel-test](https://github.com/messaging-intel-test)
- **Canonical GitHub Project:** [messaging-intel-test-project](https://github.com/orgs/messaging-intel-test/projects/1) (project 1)
- **Canonical Linear project:** [planning workspace](https://linear.app/denman/project/githubcommessaging-intel-test-2c47a9893ffe)
- **Organization documentation repository:** [messaging-intel-test/.github](https://github.com/messaging-intel-test/.github)
